<%@ Page Language="C#" AutoEventWireup="true" Inherits="LocalizeAdmin_Default" EnableViewState="false" ValidateRequest="false" EnableEventValidation="false" meta:resourcekey="Page1" Culture="auto" UICulture="auto" Codebehind="Default.aspx.cs" Theme="Default" %>

<%@ Register TagPrefix="Canon" TagName="MasterHeader" Src="~/Controls/MasterHeader.ascx" %>
<%@ Register TagPrefix="Canon" TagName="UntranslatedText" Src="~/Controls/UntranslatedText.ascx" %>
...
<head runat="server">
    <title>Localization - Canon Monitoring</title>
    ...
    <form id="MainForm" runat="server">
		...
		<div align="left" style="padding: 20px;">
			...
			<div class="blackborder">
				...
				<table cellpadding="0" cellspacing="15" style="width: 820px;">
					<tr>
						<td valign="top">
							 <asp:ListBox runat="server" ID="lstResourceIds" style="Height: 370px; width: 250px;" onchange="GetValue()" AccessKey="L" meta:resourcekey="lstResourceIds" />
						</td>
						<td valign="top">
							<div id="Toolbar">
								<div class="toolbarbar" style="display: none;">
									<span class="hoverbutton">
										<img runat="server" id="imgExportResources" style="display: none;" />
						            ...
						            &nbsp;
									<span class="hoverbutton">
										<img runat="server" id="imgCreateTable" visible="false" style="display: none;" />
						            ...
						            &nbsp;
									<span class="hoverbutton">
										<img runat="server" id="imgBackup" style="display: none;" />
										<asp:LinkButton runat="server" ID="btnBackup" Title="Backup Resource Database" Text="Backup Table" OnClientClick="Backup();return false;" meta:resourcekey="btnBackup" />
									</span>
								</div>
								
								<div class="toolbarbar">
									<span class="hoverbutton">
										<img runat="server" id="imgRefresh" style="display: none;" />
									...
									&nbsp;
									<span class="hoverbutton">
										<img runat="server" id="imgRecycleApp" style="display: none;" />
									...
									&nbsp;
									<span class="hoverbutton">
										<img runat="server" id="imgImport" style="display: none;" />
							...
							<asp:Label runat="server" id="lblResourceSetLabel" Font-Bold="True" Text="ResourceSet:" meta:resourcekey="lblResourceSetLabel" />
							<br />
							...
							<asp:DropDownList
								...
								width="500px"
								AutoPostBack="True"
								meta:resourcekey="lstResourceSet" />
								
							<a href="javascript:DeleteResourceSet();" class="hoverbutton" style="display: none;">
								<asp:Image  runat="server"  ID="imgDeleteResourceSet" Title="Delete ResourceSet" meta:resourcekey="imgDeleteResourceSet" />
							</a>
							<a href="javascript:ShowResourceSetRenameDisplay();" class="hoverbutton" style="display: none;">
								<asp:Image  runat="server"  ID="imgRenameResourceSet" Title="Rename ResourceSet" meta:resourcekey="imgRenameResourceSet" />
							</a>
							
							<br />
							<br />
							
							<asp:Label runat="server" ID="lblLanguages" Font-Bold="True" meta:resourcekey="lblLanguages" Text="Languages:" />
							<br />
							
							<asp:ListBox ID="lstLanguages" runat="server" style="" Height="50px" Width="500px" onchange="GetValue()" meta:resourcekey="lstLanguages" />
							<br />
							<br />

							<asp:Label runat="server" ID="lblValue" Font-Bold="True" meta:resourcekey="lblValue" Text="Value:" />
							<br />
							
							<asp:TextBox runat="server" ID="txtValue" TextMode="MultiLine" Height="50px" Width="500px" AccessKey="V" Tooltip="Resource Value (Alt-V)" meta:resourcekey="txtValue" />
							<br />
							...
							<asp:Button style="display: none;" runat="server" ID="btnAddResourceDisplay"  Text="Add" OnClientClick="ShowNewResourceDisplay();return false;" AccessKey="a" meta:resourcekey="btnAddResourceDisplay"  />
							<asp:Button style="display: none;" runat="server" ID="btnDelete"  Text="Delete" OnClientClick="DeleteResource();return false;" accesskey="d" meta:resourcekey="btnDelete" />
							<asp:Button style="display: none;" runat="server" ID="btnRename"  Text="Rename" OnClientClick="ShowRenameResourceDisplay();return false;" meta:resourcekey="btnRename" />
							<asp:Button style="display: none;" runat="server" id="btnTranslate" Text="Translate" OnClientClick="ShowTranslationDisplay();return false" meta:resourcekey="btnTranslate" />
							<br />
							<br />

							<div id="divValues" class="gridalternate" style="width: 490px; height: 100px; overflow-y: scroll; display: none;">
							...
							</div>            
						</td>
					</tr>
				...
				<div id="lblMessages" style="padding: 4px 8px; color: #333333; border-top: dotted 1px #5c5c5c;">
					<%= Res("Ready") %>
				</div>
			...
			<ww:wwDbResourceControl id="ResourceAdmin" runat="server" meta:resourcekey="ResourceAdmin" CssClass="errordisplay" Width="250px" visible="false" />
			<ww:wwMethodCallback ID="Callback" runat="server" />
		    
		    <Canon:UntranslatedText runat="server" ID="UntranslatedTextControl" />
			...
			<script type="text/javascript">
				...
				function GetResourceStrings_Callback(Resources)
				{
					...
					var Output = "<div style='margin-top: 3px; padding: 0px 5px 5px 5px; border-bottom: solid 1px #d3d3d3; font-weight: bold;'>" +
								 ResourceId + "</div>";
					for( var x = 0; x < Resources.length; x++)
					{
						...
						Output = Output +  "<div style='padding: 5px; border-bottom: solid 1px #d3d3d3;'><a href='javascript:ChangeLanguage(\"" + Resource.Key  + "\");' >" + Resource.Key + "</a>: " + Resource.Value + "</div>\r\n";
					}
				...
				{
					var ResourceSet = $w("lstResourceSet").value;
					Callback.GetResourceList(ResourceSet,GetResourceList_Callback,OnPageError);
				}
